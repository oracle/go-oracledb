...
func initMessagesEn() {
	...
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(InvalidCredential), "invalid credential or not authorized: %s")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(ConnectionLost), "database connection closed by peer")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(AliasNotFound), "cannot connect to database. Could not find alias %s.")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(NoListenerAvailable), "cannot connect. No listener at %s")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(ProtocolViolation), "protocol violation")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(ProtocolViolationLimitExceeded), "protocol violation, limit of %s exceeded: limit [%d] value [%d]")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(LobClosed), "LOB already closed in the same transaction.")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(LobOpen), "LOB already opened in the same transaction.")
	...
	// Comment  : N/A
	message.SetString(language.English, string(ChannelReadFailed), "End-of-stream detected. The remote peer has closed the connection.")
	// Document : Yes
	...
	// Comment  : N/A
	message.SetString(language.English, string(ChannelWriteFailed), "Write to channel failed.")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(UnknownHost), "unknown host specified.")
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(LogonDenied), "invalid credential or not authorized")
	// Document: Yes
	...
	message.SetString(language.English, string(InvalidServiceName), "Cannot connect to database. Service %s is not registered with the listener at host %s port %d. (CONNECTION_ID=%s)")
	// Document: Yes
	...
	message.SetString(language.English, string(NoAvailableHandler), "Cannot connect to database. No available %s handler for requested service %s at host %s port %d. (CONNECTION_ID=%s)")
	// Document: Yes
	...
	message.SetString(language.English, string(UnknownInstance), "Cannot connect to database. Instance %s for service %s not known by listener at host %s port %d. (CONNECTION_ID=%s)")
	// Document: Yes
	...
	message.SetString(language.English, string(UnresolvedAlias), "Cannot resolve connection alias due to errors in Easy Connect syntax %s")
	// Document: Yes
	...
	message.SetString(language.English, string(InvalidSID), "Cannot connect to database. SID %s is not registered with the listener at host %s port %d. (CONNECTION_ID=%s)")
	// Document: Yes
	...
	message.SetString(language.English, string(ListenerRequestTimeout), `Listener has not received client's request in time allowed`)
	// Document: No
	// Cause:    N/A
	// Action:   N/A
	// Comment:  N/A
	message.SetString(language.English, string(ConnectionClosed), "closed connection")
	// Document: No
	...
	message.SetString(language.English, string(CtxTimeout), "context timed out during %s for %s.(CONNECTION_ID=%s) ")
	// Document: Yes
	...
	//           server is reachable.
	// Comment:  N/A
	message.SetString(language.English, string(ConnCloseTimeout), "a timeout occurred while closing the network session")
	// Document: Yes
	// Cause:    The client received a server to client function that it does not
	//           know.
	// Action:   Update the client version.
	// Comment:  N/A
	message.SetString(language.English, string(UnknownSPFFunction), "unknown server to client function code received: %d")
	// Document: No
	// Cause:    The SPF message does not implement the Function interface.
	// Action:   This error should never happen in production.
	// Comment:  N/A
	message.SetString(language.English, string(SPFNotFunction), "message does not implement the Function interface")
	// Document: No
	// Cause:    Ths SPF message could not be casted to the expected message type.
	// Action:   This error should never happen in production.
	// Comment:  N/A
	message.SetString(language.English, string(InvalidSPFFunction), "message is not of the expected type: [%s]")

	// Document: No
	// Cause:    A parameter set in the connection string is invalid
	// Action:   Check connection string parameter
	// Comment:  N/A
	message.SetString(language.English, string(InvalidConnectionParameter), "invalid connection parameter value [%s] for [%s], accepted values [%s]")

	// Document: No
	// Cause:    A parameter set in more than one source is not allowed.
	// Action:   Check connection string parameter
	// Comment:  N/A
	message.SetString(language.English, string(ConflictingConnectionParameterSource), "parameter [%s] Can't be specified in more than one source")

	// Document: Yes
	// Cause:    DSN string is syntactically invalid.
	// Action:   Fix the DSN format.
	// Comment:  Arg[0]=component
	message.SetString(language.English, string(NamingDSNInvalid), "Can't parse %s from DSN")

	// Document: Yes
	// Cause:    Connection string syntax is invalid.
	// Action:   Fix the connect descriptor syntax.
	// Comment:  N/A
	message.SetString(language.English, string(NamingParseFailed), "invalid connection string")
	...
	message.SetString(language.English, string(NamingEzConnectError), "invalid value %q for %s in connection string")

	// Document: Yes
	// Cause:    The connect descriptor contains an invalid value for a field.
	// Action:   Fix the connect descriptor.
	// Comment:  Arg[0]=value; Arg[1]=field
	message.SetString(language.English, string(NamingContextError), "invalid value %q for %s in connect descriptor")
	...
	message.SetString(language.English, string(FailMarshal), "Failed to marshal message: %s")
	...
	message.SetString(language.English, string(FailUnmarshal), "Failed to unmarshal message: %s")
	...
	message.SetString(language.English, string(InvalidLOBBuffer), "Invalid LOB buffer configuration during %s (%s): %s")
	...
	message.SetString(language.English, string(LobExecError), "LOB operation failed during %s.")
	...
	message.SetString(language.English, string(UnsupportedCharacterSet), "Unsupported character set: %d")

	message.SetString(language.English, string(ConnectTimeout), "%s Timeout of %d for %s.(CONNECTION_ID=%s)")
	...
	message.SetString(language.English, string(ListenerFailed), "ORA-12500: TNS:listener failed to start a dedicated server process")
	...
	message.SetString(language.English, string(NoDispatcherAvailable), "ORA-12516: TNS:listener could not find available handler with matching protocol stack")

	message.SetString(language.English, string(ConnectFailed), "Cannot connect")
	...
	// Comment:  N/A
	message.SetString(language.English, string(TableOrViewNotFound), "table or view does not exist")
	...
	// Comment:  N/A
	message.SetString(language.English, string(InsufficientPrivilege), "insufficient privileges")
	...
	// Comment:  N/A
	message.SetString(language.English, string(InvalidTableName), "invalid table name")
	...
	// Comment:  N/A
	message.SetString(language.English, string(MissingReadPrivilege), "missing READ privilege")
	...
	message.SetString(language.English, string(ConverterEmptyInput), "Converter %s %s: empty input")
	...
	message.SetString(language.English, string(ConverterRange), "Converter %s %s: %s; expected=%v..%v")
	...
	message.SetString(language.English, string(ConverterExpectedFormat), "Converter %s %s: %s; expected=%v")
	...
	message.SetString(language.English, string(RowDecodeError), "Decode %s failed for column %s (index %d)")

	// Document: No
	// Cause:    Closing statement rows has failed
	// Action:
	// Comment:
	message.SetString(language.English, string(RowsCloseFailed), "Closing the statement's rows failed: %s")
	...
	message.SetString(language.English, string(StatementExecutionFailed), "failed to prepare %s statement: %s.")
	...
	message.SetString(language.English, string(StatementExecutionFactoryFailed), "failed to get Executor from factory, invalid type: %s for %s")

	// Document: No
	// Cause:    Factory could not provide an executor for the SQL kind and operation.
	// Action:   Verify classification logic and supported kinds for the operation.
	// Comment:  Arg[0]: SQL kind (SELECT|DML|PLSQL|OTHER); Arg[1]: operation (Query/QueryContext|Exec/ExecContext)
	message.SetString(language.English, string(StatementCloseFailed), "failed to close statement: %s")

	// Document: No
	// Cause:    A failure occurred in runQuery.
	// Action:   Inspect the cause and operation name in args[0].
	// Comment:  Arg[0]: operation (push|flush|pull|column-meta|ttioer|invalid-dcb)
	message.SetString(language.English, string(RunQueryError), "runQuery failed: %s.")

	// Document: No
	// Cause:    A failure occurred in runExec.
	// Action:   Inspect the cause and operation name in args[0].
	// Comment:  Arg[0]: operation (push|flush|pull|ttioer|unmarshal-dml-rows)
	message.SetString(language.English, string(RunExecError), "runExec failed: %s.")
	...
	message.SetString(language.English, string(CallbackFactoryError), "message factory failed: %s.")
	...
	// Comment:  N/A
	message.SetString(language.English, string(StatementParsingDanglingColon), "dangling colon at end of SQL")
	// Document: No
	...
	message.SetString(language.English, string(StatementParsingPlaceholdersArgsMismatch), "%d placeholder(s) found, but %d arguments provided")
	// Document: No
	...
	message.SetString(language.English, string(StatementParsingInvalidArgCount), "invalid argument count: provided %d, expected %d unique placeholder(s)")
	// Document: No
	...
	message.SetString(language.English, string(StatementParsingNameNotFound), "placeholder name %q not found in SQL")
	// Document: No
	...
	message.SetString(language.English, string(StatementParsingDuplicateArg), "duplicate value for placeholder %q at occurrence index %d")
	// Document: No
	...
	message.SetString(language.English, string(StatementParsingInvalidOrdinal), "invalid ordinal provided %d, number of placeholders found %d")
	// Document: No
	...
	// Comment:  Arg[0]: placeholder name (%q); Arg[1]: 1-based occurrence index (%d)
	message.SetString(language.English, string(StatementParsingMissingValue), "missing value for placeholder %q at occurrence index %d")
	// Document: No
	...
	message.SetString(language.English, string(ADTMetadataError), "invalid ADT metadata")
	message.SetString(language.English, string(ADTEncodingError), "invalid ADT collection image")
	message.SetString(language.English, string(ADTValueError), "invalid ADT value or collection operation")

	// Document: No
	message.SetString(language.English, string(CancelOperationError), "cancel operation failed")

	// Document: No
	message.SetString(language.English, string(InternalError), "internal error occurred.")
	// Document: No
	...
	// Comment:  N/A
	message.SetString(language.English, string(MissingLocalizationService), "missing localization service on shelf")
	...
	message.SetString(language.English, string(UnsupportedFeature), "%s feature is not supported")
	...
	// Comment:  N/A
	message.SetString(language.English, string(InvalidSqlOutParameter), "invalid sql.Out parameter : %s")
	...
	// Action:   Provide a non-nil pointer to a concrete value in sql.Out.Dest.
	// Comment:  N/A
	message.SetString(language.English, string(InvalidFileConfig), "failed to load configuration")
	...
	// Comment:  N/A
	message.SetString(language.English, string(NotInTransaction), "Not in transaction")
	// Document: No
	// Cause:    The provided isolation level is not supported.
	// Action:   Use one of the following isolation levels: LevelSerializable or
	//           LevelReadCommitted.
	// Comment:  N/A
	message.SetString(language.English, string(IsolationLevelNotSupported), "Isolation level not supported")
	// Document: No
	...
	// Comment:  N/A
	message.SetString(language.English, string(ConfigureTransactionError), "Failed to configure transaction")
	// Document: No
	// Cause:    An error occurred while authenticating.
	// Action:   Check the credentials and try again.
	// Comment:  N/A
	message.SetString(language.English, string(AuthenticatorError), "An error occurred during authentication")
	// Document: No
	// Cause:    An error occurred while negotiating the connection.
	// Action:   Try again.
	// Comment:  N/A
	message.SetString(language.English, string(NegotiatorError), "An error occurred while negotiating the connection")
	// Document: No
	// Cause:    An error occurred while marshalling or unmarshalling a value.
	// Action:   Try again.
	// Comment:  N/A
	message.SetString(language.English, string(MarshalEngineError), "An error occurred while marshalling or unmarshalling a value of type %s")
	// Document: No
	// Cause:    An error occurred while flushing data.
	// Action:   Try again.
	// Comment:  N/A
	message.SetString(language.English, string(MarshalEngineFlushError), "An error occurred while flushing data")
	// Document: No
	// Cause:    An error occurred while reading a message.
	// Action:   Check network connection and try again.
	// Comment:  N/A
	message.SetString(language.English, string(StreamerReadError), "An error occurred while reading a message")
	// Document: No
	// Cause:    An error occurred while writing a message.
	// Action:   Check network connection and try again.
	// Comment:  N/A
	message.SetString(language.English, string(StreamerWriteError), "An error occurred while writing a message")
	// Document: No
	// Cause:    Database is in NOMOUNT state
	// Action:   ?
	// Comment:  N/A
	message.SetString(language.English, string(DatabaseMountStateError), "database is in NOMOUNT state")
	// Document: Yes
	// Cause:    No username was provided
	// Action:   Provide a username and try agian.
	// Comment:  N/A
	message.SetString(language.English, string(EmptyUsernameError), "empty username not supported")
	// Document: Yes
	// Cause:    No authenticator available for given parameters.
	// Action:   Only username and password are supported.
	// Comment:  N/A
	message.SetString(language.English, string(NoAuthenticatorError), "no authenticator available for given parameters")
	// Document: No
