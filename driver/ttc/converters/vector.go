...
func EncodeVectorFloat64(v driver.Value) (common.B1Array, error) {
	values, ok := v.(common.VectorFloat64)
	if !ok {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonInvalidValue, "common.VectorFloat64")
	}
	if values == nil {
		return nil, nil
	}
...
func EncodeVectorFloat32(v driver.Value) (common.B1Array, error) {
	values, ok := v.(common.VectorFloat32)
	if !ok {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonInvalidValue, "common.VectorFloat32")
	}
	if values == nil {
		return nil, nil
	}
...
func EncodeVectorInt8(v driver.Value) (common.B1Array, error) {
	values, ok := v.(common.VectorInt8)
	if !ok {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonInvalidValue, "common.VectorInt8")
	}
	if values == nil {
		return nil, nil
	}
...
func EncodeVectorBinary(v driver.Value) (common.B1Array, error) {
	values, ok := v.(common.VectorBinary)
	if !ok {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonInvalidValue, "common.VectorBinary")
	}
	if values == nil {
		return nil, nil
	}
...
func DecodeVector(data common.B1Array) (driver.Value, error) {
	if len(data) == 0 {
		return nil, nil
	}
...
func encodeVectorFloat64(values []float64) (common.B1Array, error) {
	if len(values) > maxVectorDimensions {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonOutOfRange, "dimensions<=65535")
	}
...
func encodeVectorFloat32(values []float32) (common.B1Array, error) {
	if len(values) > maxVectorDimensions {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonOutOfRange, "dimensions<=65535")
	}
...
func encodeVectorInt8(values []int8) (common.B1Array, error) {
	if len(values) > maxVectorDimensions {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonOutOfRange, "dimensions<=65535")
	}
...
func encodeVectorBinary(values common.VectorBinary) (common.B1Array, error) {
	if len(values) > maxVectorBinaryDimensions/8 {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Encode", common.ReasonOutOfRange, "dimensions<=65528")
	}
	out := make([]byte, vectorHeaderBytes+len(values))
...
func decodeVector(data []byte) (driver.Value, error) {
	if len(data) < vectorBaseHeaderBytes {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidLength, ">="+strconv.Itoa(vectorBaseHeaderBytes))
	}
	if data[0] != vectorMagic {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidFormat, "magic=0xDB")
	}
	...
	if flags&vectorFlagOptional != 0 {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidFormat, "optional-flags-unsupported")
	}
	if flags&vectorFlagSparse != 0 {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidFormat, "sparse-unsupported")
	}
	if version != vectorVersionV0 {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidValue, "version=0")
	}
	...
	if len(data) != expected {
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidLength, "=="+strconv.Itoa(expected))
	}
	...
	case vectorTypeBinary:
		...
		return out, nil
	default:
		return nil, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidFormat, "type=2|3|4|5")
	}
}
...
func vectorValueByteLength(typeCode byte, dimensions uint32) (int, error) {
	...
	case vectorTypeFloat64:
		if dimensions > maxVectorDimensions {
			return 0, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonOutOfRange, "dimension-count")
		}
	...
	case vectorTypeBinary:
		...
		if dimensions%8 != 0 {
			return 0, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidValue, "binary-dimension-count-multiple-of-8")
		}
		return int(dimensions / 8), nil
	default:
		return 0, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidFormat, "unknown-type")
	}
}

func decodeFloat64Dimension(raw []byte, flags uint16) (float64, error) {
	if len(raw) != 8 {
		return 0, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidLength, 8)
	}
...
func decodeFloat32Dimension(raw []byte, flags uint16) (float32, error) {
	if len(raw) != 4 {
		return 0, common.NewOracleError(common.ConverterExpectedFormat, nil, vectorTypeName, "Decode", common.ReasonInvalidLength, 4)
	}
	ordered := orderVectorBytes(raw, flags)
	if (flags & vectorFlagIEEE) != 0 {
