...
// arrayNode implements common.JSONArrayNode.
...
// Errors:
//   - none.
func (array *arrayNode) Kind() common.Kind {
	return common.KindArray
}
...
func (array *arrayNode) GetValue(opts common.JSONOption) (any, error) {
...
func (array *arrayNode) StringWithOption(opts common.JSONOption) (string, error) {
...
// Get implements common.JSONArrayNode.Get.
//
// Input:
...
func (array *arrayNode) Get(index int) (common.JSONNode, bool) {
...
// Len implements common.JSONArrayNode.Len.
//
// Input:
//   - none.
//
...
// Value implements common.JSONArrayNode.Value.
//
// Input:
//   - opts: JSON materialization options.
//
...
// Errors:
//   - child node construction or value decoding failure.
func (array *arrayNode) Value(opts common.JSONOption) ([]any, error) {
