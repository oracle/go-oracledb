...
var testCases = []oracleTest.CategorizedTestCase{
	...
	{Name: "TestProcessPacketCompressedTCP", Categories: "unitary", Exclusive: false, Fn: TestProcessPacketCompressedTCP},
	{Name: "TestSendPacketCompressedTCP", Categories: "unitary", Exclusive: false, Fn: TestSendPacketCompressedTCP},
