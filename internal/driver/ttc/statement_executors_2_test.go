...
// TestStatementProcessor_RejectsUnpreparedStreamedLobInput verifies that the
// low-level bind encoder rejects a streamed LOB that was not converted to a
// temporary locator by the statement bind pipeline.
