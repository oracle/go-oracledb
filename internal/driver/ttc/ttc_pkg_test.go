...
var testCases = []oracleTest.CategorizedTestCase{
	...
	{Name: "TestBeginTransactionSetupFailures", Categories: "unitary", Exclusive: false, Fn: TestBeginTransactionSetupFailures},
	...
	{Name: "TestBeginSessionlessTxValidationPaths", Categories: "unitary", Exclusive: false, Fn: TestBeginSessionlessTxValidationPaths},
