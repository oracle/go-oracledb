...
func newTTIrxh() driverCommon.Message[driverCommon.MessageType] {
	return &tTIrxh{}
}

// GetMsgCode implements Message.GetMsgCode, returning the TTC RXH message code.
func (p *tTIrxh) GetMsgCode() driverCommon.MessageType {
	return TTIRXH
}
