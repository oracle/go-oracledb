...
func newTTISTA() driverCommon.Message[driverCommon.MessageType] {
	return &ttiSTA{
...
func newTTISTAWithEndOfCallStatusSupport() driverCommon.Message[driverCommon.MessageType] {
	return &ttiSTA{
...
func (sta *ttiSTA) GetMsgCode() driverCommon.MessageType {
	return TTISTA
}
