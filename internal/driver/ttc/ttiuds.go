...
type udsProvider interface {
	getOac() *tTIoac
	nullable() bool
	getColumnName() driverCommon.B1Array
	getSchemaName() driverCommon.B1Array
	getTypeName() driverCommon.B1Array
	getKernelPosition() driverCommon.UB2
	getColumnFlags() driverCommon.UB4
}
...
func (p *tTIuds) getSchemaName() driverCommon.B1Array {
	return p.schemaName
}

// getTypeName returns the type name B1Array.
func (p *tTIuds) getTypeName() driverCommon.B1Array {
	return p.typeName
}

// getKernelPosition returns the kernel position for this column.
func (p *tTIuds) getKernelPosition() driverCommon.UB2 {
	return p.kernelPosition
}

// getColumnFlags returns the column flags.
func (p *tTIuds) getColumnFlags() driverCommon.UB4 {
