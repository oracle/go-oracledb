...
type tTIuds24 struct {
	*tTIuds20
	vectorDim  driverCommon.UB4 // vectorDim is the vector dimension (for VECTOR type columns).
	vectorType driverCommon.UB1 // vectorType is the type of data in the vector.
	vectorFlag driverCommon.UB1 // vectorFlag is the vector flag.
}
