...
// TestCategoryExecutor provides the standard categorized-test entry point for
// this public datatype package.
func TestCategoryExecutor(t *testing.T) {
	oracleTest.RunCategoryExecutor(t, TestCategories, testCases)
}
