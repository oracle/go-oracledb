...
var testCases = []oracleTest.CategorizedTestCase{
	...
	{Name: "TestDriver_ConnectorDriver", Categories: "unitary", Exclusive: false, Fn: TestDriver_ConnectorDriver},
	...
	{Name: "TestDriver_PreparedInsertReuse", Categories: "functional", Exclusive: false, Fn: TestDriver_PreparedInsertReuse},
	...
	{Name: "TestDriver_SavepointRollback", Categories: "functional", Exclusive: false, Fn: TestDriver_SavepointRollback},
