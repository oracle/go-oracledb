...
var testCases = []oracleTest.CategorizedTestCase{
	...
	{Name: "TestLOBMarkers_PreserveTheirSuppliedValues", Categories: "unitary", Exclusive: false, Fn: TestLOBMarkers_PreserveTheirSuppliedValues},
	{Name: "TestDriver_LobPreparedInsertClobSmall", Categories: "functional", Exclusive: false, Fn: TestDriver_LobPreparedInsertClobSmall},
	{Name: "TestDriver_LobPreparedInsertClobLarge", Categories: "functional", Exclusive: false, Fn: TestDriver_LobPreparedInsertClobLarge},
	{Name: "TestDriver_LobPreparedInsertBlobSmall", Categories: "functional", Exclusive: false, Fn: TestDriver_LobPreparedInsertBlobSmall},
	{Name: "TestDriver_LobPreparedInsertBlobLarge", Categories: "functional", Exclusive: false, Fn: TestDriver_LobPreparedInsertBlobLarge},
	...
	{Name: "TestDriver_LobDirectTemporary", Categories: "functional", Exclusive: false, Fn: TestDriver_LobDirectTemporary},
	{Name: "TestDriver_LobDirectUnicodeAndCancellation", Categories: "functional", Exclusive: false, Fn: TestDriver_LobDirectUnicodeAndCancellation},
	{Name: "TestDriver_LobDirectPersistentHandoff", Categories: "functional", Exclusive: false, Fn: TestDriver_LobDirectPersistentHandoff},
	{Name: "TestDriver_LobDirectLifecycleRejections", Categories: "functional", Exclusive: false, Fn: TestDriver_LobDirectLifecycleRejections},
	{Name: "TestDriver_LocatorBackedLOBQueryLifecycle", Categories: "functional", Exclusive: false, Fn: TestDriver_LocatorBackedLOBQueryLifecycle},
	{Name: "TestDriver_LobQueryLocatorSurvivesRowsNext", Categories: "functional", Exclusive: false, Fn: TestDriver_LobQueryLocatorSurvivesRowsNext},
	{Name: "TestDriver_LobBindLargeAndEmptyValues", Categories: "functional", Exclusive: false, Fn: TestDriver_LobBindLargeAndEmptyValues},
	{Name: "TestDriver_LobDirectValidation", Categories: "functional", Exclusive: false, Fn: TestDriver_LobDirectValidation},
	{Name: "TestDriver_LobDirectPersistentWriteTo", Categories: "functional", Exclusive: false, Fn: TestDriver_LobDirectPersistentWriteTo},
	...
	{Name: "TestDriver_LobTableSelectClob", Categories: "functional", Exclusive: false, Fn: TestDriver_LobTableSelectClob},
	{Name: "TestDriver_LobTableSelectBlob", Categories: "functional", Exclusive: false, Fn: TestDriver_LobTableSelectBlob},
	{Name: "TestDriver_LobTableInsertSelectClobBlobMultiRows", Categories: "functional", Exclusive: false, Fn: TestDriver_LobTableInsertSelectClobBlobMultiRows},
	...
	{Name: "TestDriver_LobPreparedInsertNclobSmall", Categories: "functional", Exclusive: false, Fn: TestDriver_LobPreparedInsertNclobSmall},
