...
var testCases = []oracleTest.CategorizedTestCase{
	...
	{Name: "TestDriver_CreateInBatchesEquivalent", Categories: "functional", Exclusive: false, Fn: TestDriver_CreateInBatchesEquivalent},
	{Name: "TestDriver_BatchUpdateSliceEquivalent", Categories: "functional", Exclusive: false, Fn: TestDriver_BatchUpdateSliceEquivalent},
	{Name: "TestDriver_MixedSaveBatchEquivalent", Categories: "functional", Exclusive: false, Fn: TestDriver_MixedSaveBatchEquivalent},
	{Name: "TestDriver_JSONCreateInBatchesAndBulkUpdateEquivalent", Categories: "functional", Exclusive: false, Fn: TestDriver_JSONCreateInBatchesAndBulkUpdateEquivalent},
	{Name: "TestDriver_StringVarrayEquivalent", Categories: "functional", Exclusive: false, Fn: TestDriver_StringVarrayEquivalent},
	{Name: "TestDriver_VarrayOfObjectEquivalent", Categories: "functional", Exclusive: false, Fn: TestDriver_VarrayOfObjectEquivalent},
	{Name: "TestDriver_CreateTrigger_WithPseudoRecords", Categories: "functional", Exclusive: false, Fn: TestDriver_CreateTrigger_WithPseudoRecords},
	{Name: "TestDriver_DMLReturning_Merge_InsertGeneratedIdentity", Categories: "functional", Exclusive: false, Fn: TestDriver_DMLReturning_Merge_InsertGeneratedIdentity},
	{Name: "TestDriver_DMLReturning_PLSQLForallMerge_MixedScalars", Categories: "functional", Exclusive: false, Fn: TestDriver_DMLReturning_PLSQLForallMerge_MixedScalars},
	{Name: "TestDriver_DeleteWithRowIDSubqueryLimit", Categories: "functional", Exclusive: false, Fn: TestDriver_DeleteWithRowIDSubqueryLimit},
	{Name: "TestDriver_Select_DATE_NLSDateFormat_Session", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_DATE_NLSDateFormat_Session},
	{Name: "TestDriver_Select_DATE_IntervalArithmetic", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_DATE_IntervalArithmetic},
	{Name: "TestDriver_Select_JoinQuery", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_JoinQuery},
	{Name: "TestDriver_Select_SubqueryInFrom", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_SubqueryInFrom},
	{Name: "TestDriver_Select_GroupByHaving", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_GroupByHaving},
	{Name: "TestDriver_Select_NamedArgMultipleSameParamRefs", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_NamedArgMultipleSameParamRefs},
	{Name: "TestDriver_TRIGGER_PseudoRecords", Categories: "functional", Exclusive: false, Fn: TestDriver_TRIGGER_PseudoRecords},
	{Name: "TestSavepointRollback", Categories: "functional", Exclusive: false, Fn: TestSavepointRollback},
	{Name: "TestDriver_QueryAfterInvalidQuery", Categories: "functional", Exclusive: false, Fn: TestDriver_QueryAfterInvalidQuery},
	...
	{Name: "TestDriver_Prepared_Insert_InvalidThenValidJSON_ReusesStatement", Categories: "functional", Exclusive: false, Fn: TestDriver_Prepared_Insert_InvalidThenValidJSON_ReusesStatement},
	{Name: "TestDriver_Prepared_Insert_InvalidJSON_NegativeCase", Categories: "functional", Exclusive: false, Fn: TestDriver_Prepared_Insert_InvalidJSON_NegativeCase},
	...
	{Name: "TestDriver_Select_TIMESTAMP_SubSecond_ShortTrailingDigit", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_TIMESTAMP_SubSecond_ShortTrailingDigit},
	{Name: "TestDriver_Select_TIMESTAMP_SubSecond_FullNanosecondPrecision", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_TIMESTAMP_SubSecond_FullNanosecondPrecision},
	{Name: "TestDriver_Select_TIMESTAMP_SubSecond_BoundaryYearMinimum", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_TIMESTAMP_SubSecond_BoundaryYearMinimum},
	{Name: "TestDriver_Select_TIMESTAMP_SubSecond_BoundaryYearMaximum", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_TIMESTAMP_SubSecond_BoundaryYearMaximum},
	{Name: "TestDriver_Select_Intervals_Prepared_Named", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_Intervals_Prepared_Named},
	{Name: "TestDriver_Select_Intervals_Prepared_Ordinal", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_Intervals_Prepared_Ordinal},
	{Name: "TestDriver_Select_Intervals_Negative_D2S_SubSecond", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_Intervals_Negative_D2S_SubSecond},
	{Name: "TestDriver_Select_Intervals_Negative_Y2M_Positive_D2S", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_Intervals_Negative_Y2M_Positive_D2S},
	{Name: "TestDriver_Select_Intervals_Positive_Y2M_Negative_D2S", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_Intervals_Positive_Y2M_Negative_D2S},
	{Name: "TestDriver_Select_Intervals_Negative_LargeScale", Categories: "functional", Exclusive: false, Fn: TestDriver_Select_Intervals_Negative_LargeScale},
	{Name: "TestDriverConstructorsAndOpenConnector", Categories: "unitary", Exclusive: false, Fn: TestDriverConstructorsAndOpenConnector},
	{Name: "TestOracleConnectorDriverAndNoAttempts", Categories: "unitary", Exclusive: false, Fn: TestOracleConnectorDriverAndNoAttempts},
}
